...
from .models import DatosDosificacion, Formatofactura, ClienteCampos, AlmacenesCampos, ProveedoresCampos, FacturaCampos, Sucursal, Actividad, Formatodetalle
...
admin.site.register(Formatodetalle)
